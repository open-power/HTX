...
/* @(#)19	1.1  src/htx/usr/lpp/htx/bin/htxd/htxcmd.h, htxd, htxfedora 7/17/13 01:58:48 */



#ifndef HTXCLIENT__HEADER
#define HTXCLIENT__HEADER
...
extern int	htxclient_create_socket(void);
extern int	htxclient_connect(int, char *, int);
extern int	htxclient_send_command(int, char *);
extern int	htxclient_receive_response(int, htxclient_response *);
extern int	htxclient_close_socket(int);
extern void	htxclient_prepare_command_string(htxclient_command *, char *);
extern void	initialize_command_object(htxclient_command *, char *);
extern void	initialize_response_object(htxclient_response *);
