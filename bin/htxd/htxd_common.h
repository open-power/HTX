...
option option_list[] =
	{
		...
		{"-getactmdt", 0, FALSE, 1, HTXCMDLINE_COMMAND, HTXD_COMMND_STATE_SELECTED_RUNNING},
		...
		{"-getmdtsum", 0, TRUE, 1, HTXCMDLINE_COMMAND, HTXD_COMMND_STATE_RUNNING},
		{"-getecglist", 0, FALSE, 1, HTXCMDLINE_COMMAND, HTXD_COMMND_STATE_ALL},
		{"-getmdtlist", 0, FALSE, 1, HTXCMDLINE_COMMAND, HTXD_COMMND_STATE_ALL},
